...
INSERT INTO users_details(username,name,phone_no, addr, city) VALUES('user1','바이든','010-1111-2222', '마당 넓은 집', '미국');
INSERT INTO users_details(username,name,phone_no, addr, city) VALUES('user2','윤석열','010-3333-4444', '용산 청와대', '대한민국');
INSERT INTO users_details(username,name,phone_no, addr, city) VALUES('user3','시진핑','010-5555-6666', '공산당 남바원', '중국');
